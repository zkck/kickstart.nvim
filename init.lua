...
do
  ...
  vim.keymap.set('n', '<leader>cp', function () vim.fn.setreg('+', vim.fn.getreg('"')) end)
...
do
  ...
  callback = function()
    local groups = {
      "Normal", "NormalNC",           -- background
      "WinSeparator", "VertSplit",    -- line separators
      "NeoTreeNormal", "NeoTreeNormalNC", "NeoTreeEndOfBuffer", -- neo-tree
      "TelescopeNormal", "TelescopeBorder", "TelescopePromptNormal", -- telescope
    }
